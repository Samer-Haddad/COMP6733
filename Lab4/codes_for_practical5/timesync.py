...
def udpSendThread():
  ...
  while isRunning:
    ...
    sock.sendto(struct.pack("I", timestamp), ("aaaa::212:4b00:1205:2269", UDP_TIMESYNC_PORT))
    sock.sendto(struct.pack("I",timestamp),("aaaa::212:4b00:1205:23b7",UDP_TIMESYNC_PORT))
